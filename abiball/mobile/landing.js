...
// Anpassen der DIV-Gr��en
	function resize() {
		...
		// Message Zentrieren
		$messageLeft = ($(document).width() - $("#wrapper").width() )/2;
		document.getElementById('wrapper').style.left = $messageLeft + "px";
        ...
        // evtl. Footer zentrieren
        footerRebuild(); //todo unschön, funktioniert aber
	}

	// Anmeldemessage
	function meldung() {
		$("#wrapper").animate({top: "+=20"}, 500, "swing");
	}
