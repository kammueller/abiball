...
echo '<h1 id="title">Kartentausch</h1>
	...
	'.encode($bausteine[17], true).'<br>
    '.encode($bausteine[18], true).'<select name="hergeben">';
	...
	<br>
	'.encode($bausteine[19], true).'<input type="text" size="20" maxlength="32" name="VorN1"> <input type="text" size="25" maxlength="32" name="NachN1"><br>

	<p class="error" id="namen">Bitte alle Namen angeben!</p>

	<input type="reset" value="'.encode($bausteine[20], true).'"> <input type="submit" value="'.encode($bausteine[21], true).'">
	</form>';
