...
echo '<h1 id="title">Kartenbestellung</h1>
	...
	'.encode($bausteine[2], true).'<br><br>';

if ($eineKarte == 1) {
    echo encode($bausteine[3], true).' <input type="number" min="1" max="1" name="anz" value="1" style="width: 50px"><br>';
} else {
    echo encode($bausteine[3], true).' <input type="number" min="1" max="2" name="anz" value="2" style="width: 50px"><br>'; }

echo encode($bausteine[4], true).'<br>
...
if ($eineKarte == 1) { echo '
	...
	<input type="reset" value="'.encode($bausteine[5], true).'"> <input type="submit" value="'.encode($bausteine[6], true).'">
	</form><br><br>
	<p><a href="nachbestellung_cancel.php">'.encode($bausteine[7], true).'</a></p>';
