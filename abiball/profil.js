// NEUE MAIL
	...
	// Formular-Check
		function Mailwerte(el) {
			  $wert = (el != el.replace(/[^a-zA-Z0-9@\._-]/g, ""));
		}
		
		function chkMail() {
		  $ret = true;
		  Mailwerte(document.changeMail.newMail.value);
		  if ( (document.changeMail.newMail.value == "")  || (document.changeMail.newMail.value == "neue Mail-Adresse") || (document.changeMail.newMail.value.indexOf("@") == -1) || ($wert) ) {
			$("#mailA").slideDown(100);
			$ret = false;
