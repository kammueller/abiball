...
// Content
	...
	// Neue User
	if ($menge != 0) {
		echo "<b>Deine tägliche Portion Verifizierungs-Arbeit:</b><br>
		...
		Die armen ".$menge." Leute, die noch auf eine validierung warten, kannst du <a href='validate.php'>hier ein bisschen gl&uuml;cklicher machen.</a><br><br></p>"; }
	
	// Finanzler
	if ($zugriff == 'finance') {
		echo "<p><a href='bestelluebersicht.php'>Auf zur Finanz-Arbeit!!</a></p>"; }
		
	if ( ($zugriff == 'all') OR ($zugriff == 'announce') ) {
